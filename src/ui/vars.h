...
extern const char *get_var_date_time_utc();
extern void set_var_date_time_utc(const char *value);
...
extern float get_var_gnss_latitude();
extern void set_var_gnss_latitude(float value);
extern float get_var_gnss_longitude();
extern void set_var_gnss_longitude(float value);
